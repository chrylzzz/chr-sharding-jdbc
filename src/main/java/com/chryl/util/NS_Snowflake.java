...
/**
 * java edition of Twitter <b>NS_Snowflake</b>, a network service for generating
 * unique ID numbers at high scale with some simple guarantees.
 * <p>
 * https://github.com/twitter/snowflake
 */
public class NS_Snowflake {
     ...
     * elapsed since the {@link #epoch} given by users on {@link NS_Snowflake}
...
//    private final long epoch = 1451606400000L;
    private final long epoch = 1617206400000L;
     ...
     */
    public NS_Snowflake(long datacenterId, long workerId) {
    ...
    /**
     * show settings of NS_Snowflake
     */
    @Override
    public String toString() {
        return "NS_Snowflake Settings [timestampBits=" + timestampBits + ", datacenterIdBits=" + datacenterIdBits
